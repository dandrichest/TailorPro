...
namespace TailorPro.Migrations
{
    ...
    [Migration("20260527200630_AddTailorProTables")]
    partial class AddTailorProTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TailorPro.Data.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("TailorPro.Models.Customer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("TailorPro.Models.Measurement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("TailorPro.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TailorPro.Data.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TailorPro.Models.Measurement", b =>
                {
                    b.HasOne("TailorPro.Models.Customer", "Customer")
                        .WithOne("Measurement")
                        .HasForeignKey("TailorPro.Models.Measurement", "CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
